...
class Options_Framework_Admin {
     ...
     */
	 function options_page() { ?>
	    ...
	    <?php settings_errors( 'themeoptions' ); ?>
	...
	function validate_options( $input ) {
		...
		if ( isset( $_POST['reset'] ) ) {
			add_settings_error( 'themeoptions', 'restore_defaults', __( 'Default options restored.', 'textdomain' ), 'updated fade' );
	...
	function save_options_notice() {
		add_settings_error( 'themeoptions', 'save_options', __( 'Options saved.', 'textdomain' ), 'updated fade' );
	}
