...
function of_recognized_background_repeat() {
	$default = array(
		'no-repeat' => __( 'No Repeat', 'themeoptions' ),
		'repeat-x'  => __( 'Repeat Horizontally', 'themeoptions' ),
		'repeat-y'  => __( 'Repeat Vertically', 'themeoptions' ),
		'repeat'    => __( 'Repeat All', 'themeoptions' ),
		);
...
function of_recognized_background_position() {
	$default = array(
		'top left'      => __( 'Top Left', 'themeoptions' ),
		'top center'    => __( 'Top Center', 'themeoptions' ),
		'top right'     => __( 'Top Right', 'themeoptions' ),
		'center left'   => __( 'Middle Left', 'themeoptions' ),
		'center center' => __( 'Middle Center', 'themeoptions' ),
		'center right'  => __( 'Middle Right', 'themeoptions' ),
		'bottom left'   => __( 'Bottom Left', 'themeoptions' ),
		'bottom center' => __( 'Bottom Center', 'themeoptions' ),
		'bottom right'  => __( 'Bottom Right', 'themeoptions')
		);
...
function of_recognized_background_attachment() {
	$default = array(
		'scroll' => __( 'Scroll Normally', 'themeoptions' ),
		'fixed'  => __( 'Fixed in Place', 'themeoptions')
		);
...
function of_recognized_font_styles() {
	$default = array(
		'normal'      => __( 'Normal', 'themeoptions' ),
		'italic'      => __( 'Italic', 'themeoptions' ),
		'bold'        => __( 'Bold', 'themeoptions' ),
		'bold italic' => __( 'Bold Italic', 'themeoptions' )
		);
